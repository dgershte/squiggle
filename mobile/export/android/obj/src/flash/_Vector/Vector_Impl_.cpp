...
int Vector_Impl__obj::get_length( Dynamic this1){
	HX_STACK_PUSH("Vector_Impl_::get_length","flash/Vector.hx",163);
	HX_STACK_ARG(this1,"this1");
	HX_STACK_LINE(163)
...
int Vector_Impl__obj::set_length( Dynamic this1,int value){
	HX_STACK_PUSH("Vector_Impl_::set_length","flash/Vector.hx",170);
	HX_STACK_ARG(this1,"this1");
...
bool Vector_Impl__obj::get_fixed( Dynamic this1){
	HX_STACK_PUSH("Vector_Impl_::get_fixed","flash/Vector.hx",177);
	HX_STACK_ARG(this1,"this1");
	HX_STACK_LINE(177)
	return false;
}
...
bool Vector_Impl__obj::set_fixed( Dynamic this1,bool value){
	HX_STACK_PUSH("Vector_Impl_::set_fixed","flash/Vector.hx",184);
	HX_STACK_ARG(this1,"this1");
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(184)
	return value;
