...
{
HX_STACK_PUSH("OptimizedPerlin::new","flash/display/BitmapData.hx",838);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","flash/display/BitmapData.hx",985);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","flash/display/BitmapData.hx",962);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","flash/display/BitmapData.hx",848);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",911);
										{
											HX_STACK_LINE(911)
								...
								struct _Function_7_3{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",914);
										{
											HX_STACK_LINE(914)
								...
								struct _Function_7_5{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",917);
										{
											HX_STACK_LINE(917)
								...
								struct _Function_7_7{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",920);
										{
											HX_STACK_LINE(920)
								...
								struct _Function_7_9{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",923);
										{
											HX_STACK_LINE(923)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",926);
										{
											HX_STACK_LINE(926)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",929);
										{
											HX_STACK_LINE(929)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",932);
										{
											HX_STACK_LINE(932)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
