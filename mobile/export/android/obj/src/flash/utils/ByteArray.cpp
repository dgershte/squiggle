...
HX_STACK_PUSH("ByteArray::__init__","flash/utils/ByteArray.hx",712);
{

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	::flash::utils::ByteArray run(int length){
		HX_STACK_PUSH("*::_Function_1_1","flash/utils/ByteArray.hx",714);
	...
	Void run(::flash::utils::ByteArray bytes,int length){
		HX_STACK_PUSH("*::_Function_1_2","flash/utils/ByteArray.hx",715);
	...
	Array< unsigned char > run(::flash::utils::ByteArray bytes){
		HX_STACK_PUSH("*::_Function_1_3","flash/utils/ByteArray.hx",727);
		HX_STACK_ARG(bytes,"bytes");
		{
			HX_STACK_LINE(727)
	...
	int run(::flash::utils::ByteArray bytes1){
		HX_STACK_PUSH("*::_Function_1_4","flash/utils/ByteArray.hx",728);
...
::String ByteArray_obj::set_endian( ::String value){
	HX_STACK_PUSH("ByteArray::set_endian","flash/utils/ByteArray.hx",767);
	HX_STACK_THIS(this);
...
::String ByteArray_obj::get_endian( ){
	HX_STACK_PUSH("ByteArray::get_endian","flash/utils/ByteArray.hx",766);
	HX_STACK_THIS(this);
	HX_STACK_LINE(766)
...
int ByteArray_obj::get_byteLength( ){
	HX_STACK_PUSH("ByteArray::get_byteLength","flash/utils/ByteArray.hx",765);
	HX_STACK_THIS(this);
	HX_STACK_LINE(765)
	return this->length;
}
...
int ByteArray_obj::get_bytesAvailable( ){
	HX_STACK_PUSH("ByteArray::get_bytesAvailable","flash/utils/ByteArray.hx",764);
	HX_STACK_THIS(this);
	HX_STACK_LINE(764)
...
int ByteArray_obj::__throwEOFi( ){
	HX_STACK_PUSH("ByteArray::__throwEOFi","flash/utils/ByteArray.hx",749);
	HX_STACK_THIS(this);
	HX_STACK_LINE(751)
...
{
		HX_STACK_PUSH("ByteArray::__set","flash/utils/ByteArray.hx",738);
		HX_STACK_THIS(this);
...
int ByteArray_obj::__get( int pos){
	HX_STACK_PUSH("ByteArray::__get","flash/utils/ByteArray.hx",699);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_LINE(699)
...
{
		HX_STACK_PUSH("ByteArray::__fromBytes","flash/utils/ByteArray.hx",687);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bytes,"bytes");
		HX_STACK_LINE(689)
		this->b = bytes->b;
...
{
		HX_STACK_PUSH("ByteArray::writeUTFBytes","flash/utils/ByteArray.hx",674);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(679)
...
{
		HX_STACK_PUSH("ByteArray::writeUTF","flash/utils/ByteArray.hx",660);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(665)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);		HX_STACK_VAR(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeUnsignedInt","flash/utils/ByteArray.hx",653);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(653)
		this->writeInt(value);
...
{
		HX_STACK_PUSH("ByteArray::writeShort","flash/utils/ByteArray.hx",634);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(636)
...
{
		HX_STACK_PUSH("ByteArray::writeInt","flash/utils/ByteArray.hx",611);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(613)
...
{
		HX_STACK_PUSH("ByteArray::writeFloat","flash/utils/ByteArray.hx",598);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(603)
...
{
		HX_STACK_PUSH("ByteArray::writeFile","flash/utils/ByteArray.hx",589);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::writeDouble","flash/utils/ByteArray.hx",574);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(579)
...
int length = __o_length.Default(0);
	HX_STACK_PUSH("ByteArray::writeBytes","flash/utils/ByteArray.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeByte","flash/utils/ByteArray.hx",550);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(552)
...
{
		HX_STACK_PUSH("ByteArray::writeObject","flash/utils/ByteArray.hx",545);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::writeBoolean","flash/utils/ByteArray.hx",540);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(542)
		this->ensureElem(this->position,true);
...
{
		HX_STACK_PUSH("ByteArray::write_uncheck","flash/utils/ByteArray.hx",529);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::uncompress","flash/utils/ByteArray.hx",485);
		HX_STACK_THIS(this);
		...
		if (((algorithm == ::flash::utils::CompressionAlgorithm_obj::LZMA))){
			...
			struct _Function_2_1{
				inline static int Block( ::flash::utils::CompressionAlgorithm &algorithm){
					HX_STACK_PUSH("*::closure","flash/utils/ByteArray.hx",503);
					{
						HX_STACK_LINE(503)
						{
...
::flash::utils::ByteArray ByteArray_obj::slice( int begin,Dynamic end){
	HX_STACK_PUSH("ByteArray::slice","flash/utils/ByteArray.hx",437);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::setLength","flash/utils/ByteArray.hx",424);
		HX_STACK_THIS(this);
		HX_STACK_ARG(length,"length");
		HX_STACK_LINE(426)
		if (((length > (int)0))){
...
::String ByteArray_obj::readUTFBytes( int length){
	HX_STACK_PUSH("ByteArray::readUTFBytes","flash/utils/ByteArray.hx",398);
	HX_STACK_THIS(this);
	HX_STACK_ARG(length,"length");
	HX_STACK_LINE(400)
...
::String ByteArray_obj::readUTF( ){
	HX_STACK_PUSH("ByteArray::readUTF","flash/utils/ByteArray.hx",390);
	HX_STACK_THIS(this);
	HX_STACK_LINE(392)
...
int ByteArray_obj::readUnsignedShort( ){
	HX_STACK_PUSH("ByteArray::readUnsignedShort","flash/utils/ByteArray.hx",380);
	HX_STACK_THIS(this);
	HX_STACK_LINE(382)
...
int ByteArray_obj::readUnsignedInt( ){
	HX_STACK_PUSH("ByteArray::readUnsignedInt","flash/utils/ByteArray.hx",368);
	HX_STACK_THIS(this);
	HX_STACK_LINE(370)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->__throwEOFi()) );		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(371)
...
int ByteArray_obj::readUnsignedByte( ){
	HX_STACK_PUSH("ByteArray::readUnsignedByte","flash/utils/ByteArray.hx",361);
	HX_STACK_THIS(this);
	HX_STACK_LINE(361)
...
int ByteArray_obj::readShort( ){
	HX_STACK_PUSH("ByteArray::readShort","flash/utils/ByteArray.hx",349);
	HX_STACK_THIS(this);
	HX_STACK_LINE(351)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->__throwEOFi()) );		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(352)
...
{
		HX_STACK_PUSH("ByteArray::writeMultiByte","flash/utils/ByteArray.hx",345);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
