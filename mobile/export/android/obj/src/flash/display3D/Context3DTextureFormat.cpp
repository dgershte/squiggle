...
::flash::display3D::Context3DTextureFormat Context3DTextureFormat_obj::BGRA;

::flash::display3D::Context3DTextureFormat Context3DTextureFormat_obj::COMPRESSED;

::flash::display3D::Context3DTextureFormat Context3DTextureFormat_obj::COMPRESSED_ALPHA;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display3D.Context3DTextureFormat"), hx::TCanCast< Context3DTextureFormat_obj >,sStaticFields,sMemberFields,
