...
Void Program3D_obj::__construct(::openfl::gl::GLProgram program)
{
HX_STACK_PUSH("Program3D::new","flash/display3D/Program3D.hx",21);
{
	HX_STACK_LINE(21)
...
hx::ObjectPtr< Program3D_obj > Program3D_obj::__new(::openfl::gl::GLProgram program)
...
Void Program3D_obj::upload( ::openfl::gl::GLShader vertexShader,::openfl::gl::GLShader fragmentShader){
{
		HX_STACK_PUSH("Program3D::upload","flash/display3D/Program3D.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(vertexShader,"vertexShader");
		HX_STACK_ARG(fragmentShader,"fragmentShader");
		HX_STACK_LINE(33)
		::openfl::gl::GL_obj::attachShader(this->glProgram,vertexShader);
		HX_STACK_LINE(34)
		::openfl::gl::GL_obj::attachShader(this->glProgram,fragmentShader);
		HX_STACK_LINE(35)
		::openfl::gl::GL_obj::linkProgram(this->glProgram);
		HX_STACK_LINE(37)
		if (((::openfl::gl::GL_obj::getProgramParameter(this->glProgram,(int)35714) == (int)0))){
			HX_STACK_LINE(39)
			::String result = ::openfl::gl::GL_obj::getProgramInfoLog(this->glProgram);		HX_STACK_VAR(result,"result");
			HX_STACK_LINE(40)
...
{
		HX_STACK_PUSH("Program3D::dispose","flash/display3D/Program3D.hx",26);
		HX_STACK_THIS(this);
		HX_STACK_LINE(26)
		::openfl::gl::GL_obj::deleteProgram(this->glProgram);
	}
return null();
}
...
Dynamic Program3D_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"glProgram") ) { glProgram=inValue.Cast< ::openfl::gl::GLProgram >(); return inValue; }
	}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display3D.Program3D"), hx::TCanCast< Program3D_obj> ,sStaticFields,sMemberFields,
