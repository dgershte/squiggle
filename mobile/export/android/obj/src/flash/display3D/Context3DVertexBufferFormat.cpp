...
::flash::display3D::Context3DVertexBufferFormat Context3DVertexBufferFormat_obj::BYTES_4;

::flash::display3D::Context3DVertexBufferFormat Context3DVertexBufferFormat_obj::FLOAT_1;

::flash::display3D::Context3DVertexBufferFormat Context3DVertexBufferFormat_obj::FLOAT_2;

::flash::display3D::Context3DVertexBufferFormat Context3DVertexBufferFormat_obj::FLOAT_3;

::flash::display3D::Context3DVertexBufferFormat Context3DVertexBufferFormat_obj::FLOAT_4;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display3D.Context3DVertexBufferFormat"), hx::TCanCast< Context3DVertexBufferFormat_obj >,sStaticFields,sMemberFields,
