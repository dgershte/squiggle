...
Dynamic Fast_obj::get_elements( ){
	HX_STACK_PUSH("Fast::get_elements","/usr/lib/haxe/std/haxe/xml/Fast.hx",164);
	HX_STACK_THIS(this);
	HX_STACK_LINE(165)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/xml/Fast.hx",166);
			{
				...
				::haxe::xml::Fast run(){
					HX_STACK_PUSH("*::_Function_2_1","/usr/lib/haxe/std/haxe/xml/Fast.hx",168);
					{
						HX_STACK_LINE(169)
