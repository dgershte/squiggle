...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Example, Inc."),HX_CSTRING("BasicTest"),HX_CSTRING("away3d.examples.BasicTest"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",35);
			{
				...
				HX_STACK_LINE(64)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::BasicTest >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(64)
					while(((_g < _g1->length))){
						HX_STACK_LINE(64)
				...
				if ((hasMain)){
					HX_STACK_LINE(75)
					::Reflect_obj::callMethod(hx::ClassOf< ::BasicTest >(),::Reflect_obj::field(hx::ClassOf< ::BasicTest >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(81)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int(::flash::Lib_obj::REQUIRE_SHADERS))) | int(::flash::Lib_obj::DEPTH_BUFFER))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int(::flash::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Basic Test"),null(),null());
	}
return null();
}
