...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Example, Inc.", "BasicTest", "away3d.examples.BasicTest", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (BasicTest)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (BasicTest, Reflect.field (BasicTest, "main"), []);
...
@:keep class DocumentClass extends BasicTest {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Basic Test", null, { width: 0, height: 0 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (BasicTest, []);
			}
