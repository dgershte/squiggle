...
class ApplicationMain {
	...
	public static function main() {
		...
		//nme.Lib.setPackage("Example, Inc.", "Test2D", "com.squiggle.Test2D", "1.0.0");
	...
	private static function begin() {
		...
		for (methodName in Type.getClassFields(Test2D))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod(Test2D, Reflect.field (Test2D, "main"), []);
		}
		else
		{
...
class DocumentClass extends Test2D { }
