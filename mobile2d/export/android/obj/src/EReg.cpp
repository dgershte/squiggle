...
{
HX_STACK_PUSH("EReg::new","/usr/lib/haxe/std/cpp/_std/EReg.hx",28);
{
	HX_STACK_LINE(29)
...
::String EReg_obj::replace( ::String s,::String by){
	HX_STACK_PUSH("EReg::replace","/usr/lib/haxe/std/cpp/_std/EReg.hx",98);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(by,"by");
	HX_STACK_LINE(99)
			...
			if (((bool((c >= (int)49)) && bool((c <= (int)57))))){
				struct _Function_4_1{
					inline static Dynamic Block( ::EReg_obj *__this,Dynamic &c){
						HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/EReg.hx",122);
						{
							HX_STACK_LINE(122)
							try{
								HX_STACK_LINE(122)
...
Array< ::String > EReg_obj::split( ::String s){
	HX_STACK_PUSH("EReg::split","/usr/lib/haxe/std/cpp/_std/EReg.hx",74);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(75)
	int pos = (int)0;		HX_STACK_VAR(pos,"pos");
...
Dynamic EReg_obj::matchedPos( ){
	HX_STACK_PUSH("EReg::matchedPos","/usr/lib/haxe/std/cpp/_std/EReg.hx",61);
	HX_STACK_THIS(this);
	HX_STACK_LINE(61)
...
::String EReg_obj::matchedRight( ){
	HX_STACK_PUSH("EReg::matchedRight","/usr/lib/haxe/std/cpp/_std/EReg.hx",55);
	HX_STACK_THIS(this);
	HX_STACK_LINE(56)
	Dynamic p = ::EReg_obj::regexp_matched_pos(this->r,(int)0);		HX_STACK_VAR(p,"p");
	HX_STACK_LINE(57)
...
::String EReg_obj::matched( int n){
	HX_STACK_PUSH("EReg::matched","/usr/lib/haxe/std/cpp/_std/EReg.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_ARG(n,"n");
	HX_STACK_LINE(46)
...
bool EReg_obj::match( ::String s){
	HX_STACK_PUSH("EReg::match","/usr/lib/haxe/std/cpp/_std/EReg.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(37)
