...
::flash::display3D::Context3DWrapMode Context3DWrapMode_obj::CLAMP;

::flash::display3D::Context3DWrapMode Context3DWrapMode_obj::REPEAT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display3D.Context3DWrapMode"), hx::TCanCast< Context3DWrapMode_obj >,sStaticFields,sMemberFields,
	&__Create_Context3DWrapMode_obj, &__Create,
	&super::__SGetClass(), &CreateContext3DWrapMode_obj, sMarkStatics, sVisitStatic);
}
