...
::flash::display3D::Context3DProgramType Context3DProgramType_obj::FRAGMENT;

::flash::display3D::Context3DProgramType Context3DProgramType_obj::VERTEX;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display3D.Context3DProgramType"), hx::TCanCast< Context3DProgramType_obj >,sStaticFields,sMemberFields,
