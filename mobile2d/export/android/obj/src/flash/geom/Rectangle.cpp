...
::flash::geom::Point Rectangle_obj::set_topLeft( ::flash::geom::Point value){
	HX_STACK_PUSH("Rectangle::set_topLeft","flash/geom/Rectangle.hx",287);
	HX_STACK_THIS(this);
...
::flash::geom::Point Rectangle_obj::get_topLeft( ){
	HX_STACK_PUSH("Rectangle::get_topLeft","flash/geom/Rectangle.hx",286);
	HX_STACK_THIS(this);
	HX_STACK_LINE(286)
...
Float Rectangle_obj::set_top( Float value){
	HX_STACK_PUSH("Rectangle::set_top","flash/geom/Rectangle.hx",285);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(285)
...
Float Rectangle_obj::get_top( ){
	HX_STACK_PUSH("Rectangle::get_top","flash/geom/Rectangle.hx",284);
	HX_STACK_THIS(this);
	HX_STACK_LINE(284)
	return this->y;
}
...
::flash::geom::Point Rectangle_obj::set_size( ::flash::geom::Point value){
	HX_STACK_PUSH("Rectangle::set_size","flash/geom/Rectangle.hx",283);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(283)
	this->width = value->x;
...
::flash::geom::Point Rectangle_obj::get_size( ){
	HX_STACK_PUSH("Rectangle::get_size","flash/geom/Rectangle.hx",282);
	HX_STACK_THIS(this);
	HX_STACK_LINE(282)
...
Float Rectangle_obj::set_right( Float value){
	HX_STACK_PUSH("Rectangle::set_right","flash/geom/Rectangle.hx",281);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(281)
...
Float Rectangle_obj::get_right( ){
	HX_STACK_PUSH("Rectangle::get_right","flash/geom/Rectangle.hx",280);
	HX_STACK_THIS(this);
	HX_STACK_LINE(280)
...
Float Rectangle_obj::set_left( Float value){
	HX_STACK_PUSH("Rectangle::set_left","flash/geom/Rectangle.hx",279);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(279)
...
Float Rectangle_obj::get_left( ){
	HX_STACK_PUSH("Rectangle::get_left","flash/geom/Rectangle.hx",278);
	HX_STACK_THIS(this);
	HX_STACK_LINE(278)
	return this->x;
}
...
::flash::geom::Point Rectangle_obj::set_bottomRight( ::flash::geom::Point value){
	HX_STACK_PUSH("Rectangle::set_bottomRight","flash/geom/Rectangle.hx",277);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(277)
...
::flash::geom::Point Rectangle_obj::get_bottomRight( ){
	HX_STACK_PUSH("Rectangle::get_bottomRight","flash/geom/Rectangle.hx",276);
	HX_STACK_THIS(this);
	HX_STACK_LINE(276)
...
Float Rectangle_obj::set_bottom( Float value){
	HX_STACK_PUSH("Rectangle::set_bottom","flash/geom/Rectangle.hx",275);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(275)
...
Float Rectangle_obj::get_bottom( ){
	HX_STACK_PUSH("Rectangle::get_bottom","flash/geom/Rectangle.hx",274);
	HX_STACK_THIS(this);
	HX_STACK_LINE(274)
...
::flash::geom::Rectangle Rectangle_obj::_union( ::flash::geom::Rectangle toUnion){
	HX_STACK_PUSH("Rectangle::union","flash/geom/Rectangle.hx",256);
	HX_STACK_THIS(this);
...
::flash::geom::Rectangle Rectangle_obj::transform( ::flash::geom::Matrix m){
	HX_STACK_PUSH("Rectangle::transform","flash/geom/Rectangle.hx",223);
	HX_STACK_THIS(this);
	HX_STACK_ARG(m,"m");
	HX_STACK_LINE(225)
...
::String Rectangle_obj::toString( ){
	HX_STACK_PUSH("Rectangle::toString","flash/geom/Rectangle.hx",216);
	HX_STACK_THIS(this);
	HX_STACK_LINE(216)
...
{
		HX_STACK_PUSH("Rectangle::setTo","flash/geom/Rectangle.hx",206);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xa,"xa");
		HX_STACK_ARG(ya,"ya");
