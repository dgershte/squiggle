...
::String title = __o_title.Default(HX_CSTRING("OpenFL"));
	HX_STACK_PUSH("Lib::create","flash/Lib.hx",73);
	...
	HX_STACK_ARG(stageClass,"stageClass");
{
		...
		Void run(Dynamic frameHandle){
			HX_STACK_PUSH("*::_Function_1_1","flash/Lib.hx",94);
...
int flags = __o_flags.Default(0);
	HX_STACK_PUSH("Lib::createManagedStage","flash/Lib.hx",125);
	HX_STACK_ARG(width,"width");
	HX_STACK_ARG(height,"height");
	HX_STACK_ARG(flags,"flags");
{
...
::String Lib_obj::findHaxeLib( ::String library){
	HX_STACK_PUSH("Lib::findHaxeLib","flash/Lib.hx",138);
...
int args = __o_args.Default(0);
	HX_STACK_PUSH("Lib::load","flash/Lib.hx",179);
	HX_STACK_ARG(library,"library");
...
{
		HX_STACK_PUSH("Lib::loaderTrace","flash/Lib.hx",254);
...
{
		HX_STACK_PUSH("Lib::rethrow","flash/Lib.hx",272);
...
::String Lib_obj::sysName( ){
	HX_STACK_PUSH("Lib::sysName","flash/Lib.hx",311);
	HX_STACK_LINE(314)
...
Dynamic Lib_obj::tryLoad( ::String name,::String library,::String func,int args){
	HX_STACK_PUSH("Lib::tryLoad","flash/Lib.hx",323);
	HX_STACK_ARG(name,"name");
	HX_STACK_ARG(library,"library");
...
Void Lib_obj::exit( ){
{
		HX_STACK_PUSH("Lib::exit","flash/Lib.hx",382);
		HX_STACK_LINE(384)
...
{
		HX_STACK_PUSH("Lib::forceClose","flash/Lib.hx",403);
		HX_STACK_LINE(405)
...
int Lib_obj::getTimer( ){
	HX_STACK_PUSH("Lib::getTimer","flash/Lib.hx",411);
	HX_STACK_LINE(411)
...
{
		HX_STACK_PUSH("Lib::getURL","flash/Lib.hx",418);
...
Void Lib_obj::pause( ){
{
		HX_STACK_PUSH("Lib::pause","flash/Lib.hx",425);
		HX_STACK_LINE(425)
...
{
		HX_STACK_PUSH("Lib::postUICallback","flash/Lib.hx",432);
...
Void Lib_obj::resume( ){
{
		HX_STACK_PUSH("Lib::resume","flash/Lib.hx",443);
		HX_STACK_LINE(443)
...
{
		HX_STACK_PUSH("Lib::setIcon","flash/Lib.hx",450);
...
{
		HX_STACK_PUSH("Lib::setPackage","flash/Lib.hx",458);
...
{
		HX_STACK_PUSH("Lib::__setCurrentStage","flash/Lib.hx",470);
...
{
		HX_STACK_PUSH("Lib::trace","flash/Lib.hx",477);
...
::flash::display::MovieClip Lib_obj::get_current( ){
	HX_STACK_PUSH("Lib::get_current","flash/Lib.hx",491);
	HX_STACK_LINE(493)
	if (((::flash::Lib_obj::__current == null()))){
		HX_STACK_LINE(495)
...
::flash::display::Stage Lib_obj::get_stage( ){
	HX_STACK_PUSH("Lib::get_stage","flash/Lib.hx",510);
	HX_STACK_LINE(512)
	if (((::flash::Lib_obj::__stage == null()))){
		HX_STACK_LINE(512)
