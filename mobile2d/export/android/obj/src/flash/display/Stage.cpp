...
{
HX_STACK_PUSH("Stage::new","flash/display/Stage.hx",90);
{
	HX_STACK_LINE(92)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_PUSH("Stage::get_stageWidth","flash/display/Stage.hx",1309);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1309)
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_PUSH("Stage::get_stageHeight","flash/display/Stage.hx",1302);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1302)
...
bool Stage_obj::set_stageFocusRect( bool value){
	HX_STACK_PUSH("Stage::set_stageFocusRect","flash/display/Stage.hx",1294);
	HX_STACK_THIS(this);
...
bool Stage_obj::get_stageFocusRect( ){
	HX_STACK_PUSH("Stage::get_stageFocusRect","flash/display/Stage.hx",1293);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1293)
...
::flash::display::Stage Stage_obj::get_stage( ){
	HX_STACK_PUSH("Stage::get_stage","flash/display/Stage.hx",1286);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1286)
...
::flash::display::StageScaleMode Stage_obj::set_scaleMode( ::flash::display::StageScaleMode value){
	HX_STACK_PUSH("Stage::set_scaleMode","flash/display/Stage.hx",1278);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1280)
...
::flash::display::StageScaleMode Stage_obj::get_scaleMode( ){
	HX_STACK_PUSH("Stage::get_scaleMode","flash/display/Stage.hx",1270);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1272)
...
::flash::display::StageQuality Stage_obj::set_quality( ::flash::display::StageQuality value){
	HX_STACK_PUSH("Stage::set_quality","flash/display/Stage.hx",1262);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1264)
...
::flash::display::StageQuality Stage_obj::get_quality( ){
	HX_STACK_PUSH("Stage::get_quality","flash/display/Stage.hx",1254);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1256)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_PUSH("Stage::get_isOpenGL","flash/display/Stage.hx",1247);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1247)
...
Float Stage_obj::set_frameRate( Float value){
	HX_STACK_PUSH("Stage::set_frameRate","flash/display/Stage.hx",1237);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1239)
...
::flash::display::InteractiveObject Stage_obj::set_focus( ::flash::display::InteractiveObject value){
	HX_STACK_PUSH("Stage::set_focus","flash/display/Stage.hx",1220);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1222)
	if (((value == null()))){
...
::flash::display::InteractiveObject Stage_obj::get_focus( ){
	HX_STACK_PUSH("Stage::get_focus","flash/display/Stage.hx",1211);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1213)
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_PUSH("Stage::get_dpiScale","flash/display/Stage.hx",1204);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1204)
...
::flash::display::StageDisplayState Stage_obj::set_displayState( ::flash::display::StageDisplayState value){
	HX_STACK_PUSH("Stage::set_displayState","flash/display/Stage.hx",1196);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1198)
...
::flash::display::StageDisplayState Stage_obj::get_displayState( ){
	HX_STACK_PUSH("Stage::get_displayState","flash/display/Stage.hx",1188);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1190)
...
int Stage_obj::set_color( int value){
	HX_STACK_PUSH("Stage::set_color","flash/display/Stage.hx",1181);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1181)
...
int Stage_obj::get_color( ){
	HX_STACK_PUSH("Stage::get_color","flash/display/Stage.hx",1174);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1174)
...
::flash::display::StageAlign Stage_obj::set_align( ::flash::display::StageAlign value){
	HX_STACK_PUSH("Stage::set_align","flash/display/Stage.hx",1166);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1168)
...
::flash::display::StageAlign Stage_obj::get_align( ){
	HX_STACK_PUSH("Stage::get_align","flash/display/Stage.hx",1158);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1160)
...
Float Stage_obj::__updateNextWake( ){
	HX_STACK_PUSH("Stage::__updateNextWake","flash/display/Stage.hx",1128);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1130)
...
{
		HX_STACK_PUSH("Stage::__stopDrag","flash/display/Stage.hx",1120);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__startDrag","flash/display/Stage.hx",1087);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sprite,"sprite");
...
{
		HX_STACK_PUSH("Stage::__setActive","flash/display/Stage.hx",1037);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(1037)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((bool((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() != null())) && bool(focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >()->get_needsSoftKeyboard())))){
					...
					Void run(){
						HX_STACK_PUSH("*::_Function_4_1","flash/display/Stage.hx",1061);
						{
							HX_STACK_LINE(1061)
...
{
		HX_STACK_PUSH("Stage::__render","flash/display/Stage.hx",1011);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__pollTimers","flash/display/Stage.hx",995);
		HX_STACK_THIS(this);
		HX_STACK_LINE(997)
...
{
		HX_STACK_PUSH("Stage::__onTouch","flash/display/Stage.hx",939);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onSysWM","flash/display/Stage.hx",931);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(933)
...
{
		HX_STACK_PUSH("Stage::__onResize","flash/display/Stage.hx",923);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onRenderContext","flash/display/Stage.hx",915);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onMouse","flash/display/Stage.hx",798);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
...
{
		HX_STACK_PUSH("Stage::__onKey","flash/display/Stage.hx",749);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(751)
...
{
		HX_STACK_PUSH("Stage::__onJoystick","flash/display/Stage.hx",630);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(632)
		...
		if (  ( _switch_1==HX_CSTRING("axisMove"))){
			struct _Function_2_1{
				inline static Array< Float > Block( ::flash::display::Stage_obj *__this,Dynamic &event){
					HX_STACK_PUSH("*::closure","flash/display/Stage.hx",638);
					{
						HX_STACK_LINE(638)
...
{
		HX_STACK_PUSH("Stage::__onFocus","flash/display/Stage.hx",598);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(600)
		Array< ::Dynamic > stack = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(stack,"stack");
...
{
		HX_STACK_PUSH("Stage::__onChange","flash/display/Stage.hx",585);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(587)
		::flash::display::DisplayObject object = this->__findByID(event->__Field(HX_CSTRING("id"),true));		HX_STACK_VAR(object,"object");
...
Float Stage_obj::__nextFrameDue( Float otherTimers){
	HX_STACK_PUSH("Stage::__nextFrameDue","flash/display/Stage.hx",561);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__drag","flash/display/Stage.hx",519);
		HX_STACK_THIS(this);
...
Dynamic Stage_obj::__processStageEvent( Dynamic event){
	HX_STACK_PUSH("Stage::__processStageEvent","flash/display/Stage.hx",511);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(513)
...
try {
{
		HX_STACK_PUSH("Stage::__doProcessStageEvent","flash/display/Stage.hx",333);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(335)
		...
		try{
			...
			switch( (int)(type)){
				...
				case (int)16: {
					struct _Function_3_1{
						inline static ::flash::display::TouchInfo Block( ::flash::display::Stage_obj *__this,Dynamic &event){
							HX_STACK_PUSH("*::closure","flash/display/Stage.hx",416);
							{
								HX_STACK_LINE(416)
								int key = event->__Field(HX_CSTRING("value"),true);		HX_STACK_VAR(key,"key");
								HX_STACK_LINE(416)
				...
				case (int)17: {
					struct _Function_3_1{
						inline static ::flash::display::TouchInfo Block( ::flash::display::Stage_obj *__this,Dynamic &event){
							HX_STACK_PUSH("*::closure","flash/display/Stage.hx",421);
							{
								HX_STACK_LINE(421)
								int key = event->__Field(HX_CSTRING("value"),true);		HX_STACK_VAR(key,"key");
								HX_STACK_LINE(421)
...
{
		HX_STACK_PUSH("Stage::dummyTrace","flash/display/Stage.hx",328);
		HX_STACK_THIS(this);
		HX_STACK_LINE(328)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),328,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_PUSH("Stage::__checkRender","flash/display/Stage.hx",286);
		HX_STACK_THIS(this);
		HX_STACK_LINE(286)
		if (((this->frameRate > (int)0))){
			HX_STACK_LINE(290)
...
bool Stage_obj::__checkInOuts( ::flash::events::MouseEvent event,Array< ::Dynamic > stack,::flash::display::TouchInfo touchInfo){
	HX_STACK_PUSH("Stage::__checkInOuts","flash/display/Stage.hx",216);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
...
{
		HX_STACK_PUSH("Stage::__checkFocusInOuts","flash/display/Stage.hx",184);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(stack,"stack");
		HX_STACK_LINE(186)
...
{
		HX_STACK_PUSH("Stage::showCursor","flash/display/Stage.hx",177);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::setFullscreen","flash/display/Stage.hx",157);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::setScreenMode","flash/display/Stage.hx",152);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::setResolution","flash/display/Stage.hx",147);
		HX_STACK_THIS(this);
		HX_STACK_ARG(width,"width");
		HX_STACK_ARG(height,"height");
		HX_STACK_LINE(147)
...
{
		HX_STACK_PUSH("Stage::resize","flash/display/Stage.hx",140);
		HX_STACK_THIS(this);
		HX_STACK_ARG(width,"width");
		HX_STACK_ARG(height,"height");
		HX_STACK_LINE(140)
...
{
		HX_STACK_PUSH("Stage::invalidate","flash/display/Stage.hx",133);
		HX_STACK_THIS(this);
		HX_STACK_LINE(133)
		this->__invalid = true;
	}
...
int run(){
	HX_STACK_PUSH("Stage::getOrientation","flash/display/Stage.hx",119);
	HX_STACK_LINE(119)
...
int run(){
	HX_STACK_PUSH("Stage::getNormalOrientation","flash/display/Stage.hx",126);
	HX_STACK_LINE(126)
...
{
		HX_STACK_PUSH("Stage::setFixedOrientation","flash/display/Stage.hx",162);
...
bool run(int orientation){
	HX_STACK_PUSH("Stage::shouldRotateInterface","flash/display/Stage.hx",170);
	HX_STACK_ARG(orientation,"orientation");
	HX_STACK_LINE(170)
