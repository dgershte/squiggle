...
bool DisplayObjectContainer_obj::set_tabChildren( bool value){
	HX_STACK_PUSH("DisplayObjectContainer::set_tabChildren","flash/display/DisplayObjectContainer.hx",527);
	HX_STACK_THIS(this);
...
bool DisplayObjectContainer_obj::get_tabChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::get_tabChildren","flash/display/DisplayObjectContainer.hx",526);
	HX_STACK_THIS(this);
	HX_STACK_LINE(526)
	return false;
}
...
int DisplayObjectContainer_obj::get_numChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::get_numChildren","flash/display/DisplayObjectContainer.hx",525);
	HX_STACK_THIS(this);
	HX_STACK_LINE(525)
...
bool DisplayObjectContainer_obj::set_mouseChildren( bool value){
	HX_STACK_PUSH("DisplayObjectContainer::set_mouseChildren","flash/display/DisplayObjectContainer.hx",517);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(519)
...
bool DisplayObjectContainer_obj::get_mouseChildren( ){
	HX_STACK_PUSH("DisplayObjectContainer::get_mouseChildren","flash/display/DisplayObjectContainer.hx",516);
	HX_STACK_THIS(this);
	HX_STACK_LINE(516)
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__swapChildrenAt","flash/display/DisplayObjectContainer.hx",489);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__setChildIndex","flash/display/DisplayObjectContainer.hx",411);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__removeChildFromArray","flash/display/DisplayObjectContainer.hx",397);
		HX_STACK_THIS(this);
		HX_STACK_ARG(child,"child");
		HX_STACK_LINE(399)
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__onRemoved","flash/display/DisplayObjectContainer.hx",384);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__onAdded","flash/display/DisplayObjectContainer.hx",371);
		HX_STACK_THIS(this);
		HX_STACK_ARG(object,"object");
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__getObjectsUnderPoint","flash/display/DisplayObjectContainer.hx",358);
		HX_STACK_THIS(this);
...
int DisplayObjectContainer_obj::__getChildIndex( ::flash::display::DisplayObject child){
	HX_STACK_PUSH("DisplayObjectContainer::__getChildIndex","flash/display/DisplayObjectContainer.hx",341);
	HX_STACK_THIS(this);
	HX_STACK_ARG(child,"child");
	HX_STACK_LINE(343)
	{
...
::flash::display::DisplayObject DisplayObjectContainer_obj::__findByID( int id){
	HX_STACK_PUSH("DisplayObjectContainer::__findByID","flash/display/DisplayObjectContainer.hx",314);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(316)
	if (((this->__id == id))){
...
bool DisplayObjectContainer_obj::__contains( ::flash::display::DisplayObject child){
	HX_STACK_PUSH("DisplayObjectContainer::__contains","flash/display/DisplayObjectContainer.hx",285);
	HX_STACK_THIS(this);
	HX_STACK_ARG(child,"child");
	HX_STACK_LINE(287)
	if (((child == null()))){
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__broadcast","flash/display/DisplayObjectContainer.hx",245);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::__addChild","flash/display/DisplayObjectContainer.hx",222);
		HX_STACK_THIS(this);
		HX_STACK_ARG(child,"child");
		HX_STACK_LINE(224)
...
{
		HX_STACK_PUSH("DisplayObjectContainer::swapChildrenAt","flash/display/DisplayObjectContainer.hx",215);
		HX_STACK_THIS(this);
		HX_STACK_ARG(index1,"index1");
		HX_STACK_ARG(index2,"index2");
		HX_STACK_LINE(217)
...
{
		HX_STACK_PUSH("DisplayObjectContainer::swapChildren","flash/display/DisplayObjectContainer.hx",199);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObjectContainer::setChildIndex","flash/display/DisplayObjectContainer.hx",192);
		HX_STACK_THIS(this);
		HX_STACK_ARG(child,"child");
		HX_STACK_ARG(index,"index");
		HX_STACK_LINE(194)
	...
	HX_STACK_ARG(endIndex,"endIndex");
{
		...
		if (((beginIndex > (this->__children->length - (int)1)))){
			...
			if (((bool((bool((endIndex < beginIndex)) || bool((beginIndex < (int)0)))) || bool((endIndex > this->__children->length))))){
				HX_STACK_LINE(175)
				hx::Throw (::flash::errors::RangeError_obj::__new(HX_CSTRING("The supplied index is out of bounds.")));
			}
		}
		HX_STACK_LINE(181)
