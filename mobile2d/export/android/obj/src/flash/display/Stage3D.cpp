...
{
HX_STACK_PUSH("Stage3D::new","flash/display/Stage3D.hx",30);
{
	HX_STACK_LINE(30)
...
::String context3DRenderMode = __o_context3DRenderMode.Default(HX_CSTRING(""));
	HX_STACK_PUSH("Stage3D::requestContext3D","flash/display/Stage3D.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_ARG(context3DRenderMode,"context3DRenderMode");
{
		HX_STACK_LINE(38)
		this->context3D = ::flash::display3D::Context3D_obj::__new();
		HX_STACK_LINE(39)
		this->dispatchEvent(::flash::events::Event_obj::__new(::flash::events::Event_obj::CONTEXT3D_CREATE,null(),null()));
	}
return null();
}
...
Dynamic Stage3D_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"context3D") ) { context3D=inValue.Cast< ::flash::display3D::Context3D >(); return inValue; }
	}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flash.display.Stage3D"), hx::TCanCast< Stage3D_obj> ,sStaticFields,sMemberFields,
